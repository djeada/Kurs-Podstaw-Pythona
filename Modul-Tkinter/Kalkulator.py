...
def inicjalizacjaPolaNaDane(root, ekran):
	...
	pole_na_dane = tk.Entry(root, borderwidth = 0, highlightcolor = 'white', highlightbackground = 'white' )
...
def inicjalizacjaPrzyciskow(root, ekran, info):
	...
	znak_rownosc = tk.Button(root, text = '=', bg ='#00BFFF', borderwidth = 0, command = oblicz(pole_na_dane, ekran, info))
