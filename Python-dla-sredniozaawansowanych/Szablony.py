...
lista_produktow = [{'nazwa': 'Tunczyk', 'cena': 30, 'ilosc': 10},{'nazwa': 'Brokul', 'cena': 7, 'ilosc': 20}, {'nazwa': 'Pomidor', 'cena': 3, 'ilosc': 10} ]

produkty = string.Template('dodales do koszyka $ilosc produktow $nazwa w cenie $cena za sztuke.')
