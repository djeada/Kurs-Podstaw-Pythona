...
<!--ts-->
  ...
  - [Średniozaawansowane](#Średniozaawansowane)
    - [Klasy-i-obiekty](#Klasy-i-obiekty)
      - [Dostęp-do-zmiennych-w-obiektach](#Dostęp-do-zmiennych-w-obiektach)
    ...
    - [Wyrażenia-regularne](#Wyrażenia-regularne)
      - [Reguły-przy-pracy-z-wyrażeniami-regularnymi](#Reguły-przy-pracy-z-wyrażeniami-regularnymi)
    - [Wyjątki](#Wyjątki)
      - [Obsługa-wyjątków](#Obsługa-wyjątków)
      - [Własny-wyjątek](#Własny-wyjątek)
      - [Wyjątki-jako-mechanizm-przepływu-sterowania](#Wyjątki-jako-mechanizm-przepływu-sterowania)
    - [Wątki](#Wątki)
    - [Procesy](#Procesy)
    - [Asyncio](#Asyncio)
    - [Lambdy](#Lambdy)
  ...
  - [Inżynieria-oprogramowania](#Inżynieria-oprogramowania)
    ...
    - [Testy-jednostkowe](#Testy-jednostkowe)
      - [Unittest](#Unittest)
      - [Pytest](#Pytest)
      - [Losowe-dane-nie-mają-miejsca-w-testach](#Losowe-dane-nie-mają-miejsca-w-testach)
      - [Od-znalezienia-buga-do-poprawnie-działającego-kodu](#Od-znalezienia-buga-do-poprawnie-działającego-kodu)
      - [Inne-typy-testów](#Inne-typy-testów)
      - [Automatyczna-generacja-danych-na-potrzeby-testów](#Automatyczna-generacja-danych-na-potrzeby-testów)
    - [Organizacja-projektu-z-testami](#Organizacja-projektu-z-testami)
    - [Dokumentacja](#Dokumentacja)
      - [reStructuredText](#reStructuredText)
      - [Jak-pisać-dobrą-dokumentację?](#Jak-pisać-dobrą-dokumentację?)
      - [Automatyczne-generowanie-dokumentacji-do-API](#Automatyczne-generowanie-dokumentacji-do-API)
